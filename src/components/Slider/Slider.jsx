                ...
                <div  id="slide1" className="carousel-item relative w-full h-[400px] lg:h-[550px]  xl:h-[700px]">
                    <div
                        ...
                        <div className="flex justify-center lg:justify-start items-center">
                            <div className="text-white w-[80%] md:w-1/2 lg:ml-32 text-center md:text-left mt-16 ">
                                <div
                                    data-aos="fade-down"
                    ...
                    <div className="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
                        <a href="#slide4" className="btn btn-sm md:btn-md btn-circle">❮</a>
                        <a href="#slide2" className="btn btn-sm md:btn-md btn-circle">❯</a>
                    </div>
                </div>
